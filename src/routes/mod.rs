...
use crate::models::{Claims, UserRegistryForm, UserResponse, UserWrapper};
use crate::persistence::{insert_user, select_user_by_id};
...
pub async fn registry_user(
    ...
    let user = select_user_by_id(&pool, last_insert_id).await?;
